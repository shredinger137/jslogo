...
const logo = new Logo;
var boxes = [0,0,0];
function lprint(x){cc.insert(x+'\n');}
function resett(){var t0 = Date.now();}
function timer(){return Date.now()-0;}
...
prims['sin'] = {nargs: 1, fcn: function(a){return extensions.sindeg(this.getnum(a));}}
prims['cos'] = {nargs: 1, fcn: function(a){return extensions.cosdeg(this.getnum(a));}}
prims['sqrt'] = {nargs: 1, fcn: function(a){return Math.sqrt(this.getnum(a));}}
prims['random2'] = {nargs: 2, fcn: function(a,b){return extensions.random.pickRandom(a,b);}}
prims['oneof'] = {nargs: 2, fcn: function(a,b){return extensions.random.oneof(a,b);}}
...
prims['pick'] = {nargs: 1, fcn: function(l){return l[extensions.random.pickRandom(0,this.getlist(l).length-1)];}}

prims['print'] = {nargs: 1, fcn: function(x){lprint(this.printstr(x));}}
...
//prims['snapimage'] = {nargs: 1, fcn: function(n){turtle.snaps[n] = canvas.toDataURL();}}
prims['drawsnap'] = {nargs: 1, fcn: function(n){this.hold= true; turtle.loadimg(turtle.snaps[n], function(){this.hold=false;});}}
