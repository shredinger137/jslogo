    ...
    return (
      <div>
        ...
        <div className="main">
          ...
          <button onClick={() => {this.setState({ view: "main" }); interpreter.runLine("st")  }} class={this.state.view == "main" ? "activeButton" : null}>Main View</button>
          <button onClick={() => this.setState({ view: "graph" })} class={this.state.view == "graph" ? "activeButton" : null}>Graph</button>
          <button onClick={() => this.setState({ view: "data" })} class={this.state.view == "data" ? "activeButton" : null}>Data</button>
